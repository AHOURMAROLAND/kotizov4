...
export default function VerificationRectoScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.titre}>CNI - Recto</Text>
        <Text style={styles.etape}>1/3</Text>
      </View>
      ...
      <View style={styles.guide}>
        <View style={styles.cadre}>
          {photo ? (
            ...
            <Text style={styles.guideTexte}>Placez le recto de votre CNI dans le cadre</Text>
          )}
        </View>
      </View>
      ...
      <View style={styles.actions}>
        ...
        {photo && (
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('VerificationVerso', { photoRecto: photo })}
          >
