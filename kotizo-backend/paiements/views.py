...
class VerifierPaiementView(APIView):
    ...
    def get(self, request, invoice_token):
        ...
        return Response({
            ...
            'paydunya_statut': invoice_status,
        })
...
class DemandeRemboursementView(APIView):
    ...
    def post(self, request):
        ...
        logger.info(
            'Demande remboursement creee',
            user_id=str(request.user.id)
        )
        return Response(
            DemandeRemboursementSerializer(demande).data,
