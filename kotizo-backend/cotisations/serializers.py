...
class CotisationCreateSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'date_expiration', 'est_recurrente',
            'periodicite', 'est_privee',
        ]
...
class CotisationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'statut', 'slug', 'est_recurrente', 'periodicite',
            'est_privee', 'date_expiration', 'date_creation',
            'createur_nom', 'createur_niveau', 'est_complete',
            'pdf_participants_url',
        ]
...
class ParticipationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Participation
        fields = [
            'id', 'participant_nom', 'participant_telephone',
            'statut', 'montant', 'date_participation',
            'date_paiement', 'recu_confirme',
            'recu_pdf_url', 'recu_image_url',
        ]
